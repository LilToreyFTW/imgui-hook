...
RtlCreateUserThread_t RtlCreateUserThread = (RtlCreateUserThread_t)GetProcAddress(GetModuleHandleA("ntdll.dll"), "RtlCreateUserThread");
...
/*
		...
		AttachScripthook();*/
		FiveM::World = Memory::PatternScan(E("48 8B 05 ? ? ? ? 48 8B 48 08 48 85 C9 74 52 8B 81"), NULL, (void*)7);
		FiveM::ReplayInterface = Memory::PatternScan(E("48 8D 0D ? ? ? ? 89 44 24 30 E8 ? ? ? ? 48 83 C4 28 C3 48 8B 05"), NULL, (void*)7);
		...
		FiveM::Camera = Memory::PatternScan(E("48 8B 05 ? ? ? ? 48 8B 98 ? ? ? ? EB"), NULL, (void*)7);
     ...
     //   FiveM::IsOnFiveM = (bool)Memory::PatternScan(E("48 89 5C 24 ?? 55 56 57 48 83 EC 70 65 4C 8B 0C 25"), NULL, NULL);
		...
		// Current FiveM builds (2024-2025): 2802, 2944, 3095, 3258, 3323, 3407, 3570, 3717
		if (SAFE_CALL(GetModuleHandleA)("FiveM_b2802_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b2802_GTAProcess.exe") ||
			SAFE_CALL(GetModuleHandleA)("FiveM_b2944_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b2944_GTAProcess.exe") ||
			SAFE_CALL(GetModuleHandleA)("FiveM_b3095_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b3095_GTAProcess.exe") ||
			SAFE_CALL(GetModuleHandleA)("FiveM_b3258_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b3258_GTAProcess.exe") ||
			SAFE_CALL(GetModuleHandleA)("FiveM_b3323_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b3323_GTAProcess.exe") ||
			SAFE_CALL(GetModuleHandleA)("FiveM_b3407_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b3407_GTAProcess.exe") ||
			SAFE_CALL(GetModuleHandleA)("FiveM_b3570_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b3570_GTAProcess.exe") ||
			SAFE_CALL(GetModuleHandleA)("FiveM_b3717_GameProcess.exe") || SAFE_CALL(GetModuleHandleA)("FiveM_b3717_GTAProcess.exe"))
		{
			FiveM::EntityType = 0x10B8;
			FiveM::Armor = 0x1530;
			FiveM::WeaponManager = 0x10D8;
